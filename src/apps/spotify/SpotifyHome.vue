  ...
  memories: [
    {
      ...
      text: 'Fue en un pequeño café del centro. Estaba nerviosa, pero tu sonrisa me puso cómoda de inmediato.',
      image: img1,
    },
    {
      index: 2,
      ...
      text: 'Tres días con los pies en la arena, sin prisa. El mejor viaje de mi vida hasta ese momento.',
      image: img2,
    },
    {
      index: 3,
      date: '24 de dezembro, 2022',
      title: 'Nuestra primera Navidad juntos',
      text: 'Familia reunida, risas y ese postre que insististe en hacer desde cero.',
      image: img3,
    },
    {
      index: 4,
      date: '13 de fevereiro, 2023',
      title: 'Aniversario de 1 año',
      text: 'Cenamos en ese restaurante con vista al río. Llegaste con flores y casi lloré.',
      image: img4,
    },
    {
      index: 5,
      date: '31 de maio, 2023',
      title: 'Nos mudamos juntos',
      text: 'Cajas por todos lados, pizza en el suelo y la mejor sensación de nuevo comienzo.',
      image: img5,
    },
    {
      index: 6,
      ...
      text: 'Contamos los segundos juntos y lo primero que hice fue abrazarte bien fuerte.',
      image: img6,
    },
  ],
  achievementGroups: [
      ...
      items: [
        {
          emoji: '🌱',
          title: 'Un Mes Juntos',
          description: 'Completaron 1 mes de historia',
          color: 'rgb(52,211,153)',
          level: 1,
          stars: 1,
          unlocked: true,
          progress: 100,
          progressLabel: '1501/30 días',
        },
        {
          emoji: '🌿',
          title: 'Tres Meses',
          description: 'Tres meses de momentos especiales',
          color: 'rgb(16,185,129)',
          level: 2,
          stars: 2,
          unlocked: true,
          progress: 100,
          progressLabel: '1501/90 días',
        },
        {
          emoji: '🌺',
          title: 'Seis Meses',
          description: 'Medio año de historias compartidas',
          color: 'rgb(244,114,182)',
          level: 3,
          stars: 3,
          unlocked: true,
          progress: 100,
          progressLabel: '1501/180 días',
        },
        {
          emoji: '🎂',
          title: '¡Un Año!',
          description: 'Un año entero de complicidad',
          color: 'rgb(240,192,96)',
          level: 4,
          stars: 4,
          unlocked: true,
          progress: 100,
          progressLabel: '1501/365 días',
        },
        {
          emoji: '💎',
          title: 'Tres Años',
          description: 'Una bonita historia que solo crece',
          color: 'rgb(96,191,250)',
          level: 5,
          stars: 5,
          unlocked: true,
          progress: 100,
          progressLabel: '1501/1095 días',
        },
        {
          emoji: '👑',
          title: 'Cinco Años',
          description: 'A mitad de camino hacia la leyenda',
          color: 'rgb(251,191,36)',
          level: 5,
          stars: 5,
          unlocked: false,
          progress: 82,
          progressLabel: '1501/1825 días',
        },
        {
          emoji: '🏆',
          title: '¡Una Década!',
          description: 'Diez años de una historia épica',
          color: 'rgb(251,146,60)',
          level: 5,
          stars: 5,
          unlocked: false,
          progress: 41,
          progressLabel: '1501/3650 días',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          description: 'Registró el primer momento especial',
          color: 'rgb(220,38,38)',
          level: 1,
          stars: 1,
          unlocked: true,
        },
        {
          emoji: '🗂️',
          title: 'Coleccionista',
          description: '5 recuerdos registrados',
          color: 'rgb(155,109,255)',
          level: 2,
          stars: 2,
          unlocked: true,
          progress: 100,
          progressLabel: '6/5 recuerdos',
        },
        {
          emoji: '📚',
          title: 'Historiador',
          description: '10 recuerdos registrados',
          color: 'rgb(96,191,250)',
          level: 3,
          stars: 3,
          unlocked: false,
          progress: 60,
          progressLabel: '6/10 recuerdos',
        },
        {
          emoji: '🏛️',
          title: 'Archivo Vivo',
          description: '20 recuerdos registrados',
          color: 'rgb(240,192,96)',
          level: 4,
          stars: 4,
          unlocked: false,
          progress: 30,
          progressLabel: '6/20 recuerdos',
        },
      ],
    },
    {
      ...
      items: [
        {
          emoji: '✍️',
          title: 'Autor de Historias',
          description: 'Escribió su propia historia de amor',
          color: 'rgb(244,114,182)',
          level: 1,
          stars: 1,
          unlocked: true,
        },
        {
          ...
          description: 'Eligió la banda sonora de la historia',
          color: 'rgb(52,211,153)',
          level: 1,
          stars: 1,
          unlocked: true,
        },
        {
          emoji: '🖼️',
          title: 'En Fotos',
          description: 'Inmortalizó momentos en fotos',
          color: 'rgb(251,146,60)',
          level: 1,
          stars: 1,
          unlocked: true,
        },
        {
          emoji: '⭐',
          title: 'Todo Perfecto',
          description: 'Completó todos los detalles de la página',
          color: 'rgb(240,192,96)',
          level: 4,
          stars: 4,
          unlocked: true,
...
const SunVisual = {
  render: () =>
    h(
      'div',
      { class: 'relative flex items-center justify-center', style: 'width: 160px; height: 160px;' },
      [
        h('div', {
          class: 'absolute rounded-full',
          style:
            'width: 160px; height: 160px; background: radial-gradient(circle, rgba(250,204,21,0.35) 0%, transparent 75%);',
        }),
        h('div', {
          class: 'absolute rounded-full',
          style:
            'width: 80px; height: 80px; background: radial-gradient(circle at 38% 35%, rgb(254,240,138) 0%, rgb(250,204,21) 40%, rgb(234,179,8) 75%, rgb(202,138,4) 100%);',
        }),
        h('div', {
          class: 'absolute rounded-full pointer-events-none',
          style:
            'width: 80px; height: 80px; background: radial-gradient(circle at 35% 30%, rgba(255,255,255,0.35) 0%, transparent 55%);',
        }),
      ],
    ),
}
    ...
    h(
      ...
      [
        h('div', {
          class: 'absolute rounded-full',
          style:
            'width: 160px; height: 160px; background: radial-gradient(circle, rgba(186,230,253,0.18) 0%, transparent 75%);',
        }),
        h(
          'div',
          {
            ...
            style:
              'width: 84px; height: 84px; background: radial-gradient(circle at 40% 35%, rgb(241,245,249) 0%, rgb(203,213,225) 45%, rgb(148,163,184) 80%, rgb(100,116,139) 100%);',
          },
          [
            h('div', {
              class: 'absolute inset-0 rounded-full',
              style:
                'background: radial-gradient(circle at 68% 45%, rgba(10,15,30,0.88) 30%, transparent 65%);',
            }),
            h('div', {
              class: 'absolute inset-0 rounded-full',
              style:
                'background: radial-gradient(circle at 32% 28%, rgba(255,255,255,0.3) 0%, transparent 50%);',
            }),
          ],
        ),
      ],
      ...
      render: () =>
        h(
          'svg',
          {
            ...
            viewBox: '0 0 24 24',
            fill: 'none',
            stroke: 'rgb(155,109,255)',
            'stroke-width': 2,
            'stroke-linecap': 'round',
            'stroke-linejoin': 'round',
            onClick: () => openModal('curiosidades'),
          },
          [
            h('path', {
      ...
      render: () =>
        h(
          'svg',
          {
            ...
            viewBox: '0 0 24 24',
            fill: 'none',
            stroke: 'rgb(96,191,250)',
            'stroke-width': 2,
            'stroke-linecap': 'round',
            'stroke-linejoin': 'round',
            onClick: () => openModal('mapa-astral'),
          },
          [
            h('polygon', {
              points:
